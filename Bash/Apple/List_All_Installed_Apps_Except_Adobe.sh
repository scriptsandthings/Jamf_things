...
#######################
#
# List_All_Installed_Apps_Except_Adobe.sh v1.2
#
# Finds and lists all installed applications on a Mac.
#       Short script to list all .app bundles on a Mac using Spotlight to search the contents of /Applications/ and /Users/.
